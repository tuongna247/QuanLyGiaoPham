...
namespace HTTLVN.QLTLH
{
    public class CategoryController : Controller
    {
        ...
        {
            Category.Add(new Category { Id = 1, Name = "Desert", ImageUrl = "Desert.jpg",Description="aaaa" });
            Category.Add(new Category { Id = 2, Name = "Hydrangeas", ImageUrl = "Hydrangeas.jpg", Description = "aaaa" });
            Category.Add(new Category { Id = 3, Name = "Tulips", ImageUrl = "Tulips.jpg", Description = "aaaa" });
        }
        ...
        public ActionResult Save(HttpPostedFileBase file)
        {
            ...
            return Json(new { ImageUrl = fileName }, "text/plain", JsonRequestBehavior.AllowGet);
        }
    }
}
